...
export const Hero: React.FC = () => {
  return (
    <section
      id="inicio"
      className="relative w-full bg-gradient-to-b from-white via-[#F4F6F9]/60 to-[#F4F6F9] pt-20 lg:pt-28 xl:pt-32 pb-12 lg:pb-16 flex items-center min-h-auto lg:min-h-[calc(100vh-80px)] overflow-hidden border-b border-[#E5E7EB]"
    >
