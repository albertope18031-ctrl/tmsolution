...
export const SupplyCard: React.FC<SupplyCardProps> = ({ category, isDragging = false }) => {
  ...
  return (
    <div className="group relative bg-white border border-[#E2E8F0] rounded-2xl p-7 flex flex-col justify-between h-full transition-all duration-300 ease-in-out hover:-translate-y-1.5 hover:shadow-[0_16px_36px_rgba(15,45,89,0.08)] hover:border-[#0F2D59]/30 overflow-hidden">
      ...
      <div>
        {/* Contenedor del Icono en Cápsula Azul Tenue (#EBF1F8) 56x56px */}
