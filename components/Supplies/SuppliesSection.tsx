...
export const SuppliesSection: React.FC = () => {
  ...
  return (
    <section
      id="suministros"
      className="relative w-full bg-[#F4F6F9] pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16 lg:pb-20 scroll-mt-[90px] border-b border-[#E5E7EB] transition-colors overflow-hidden"
    >
